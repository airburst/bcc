...
type ManagedUserFormProps = {
  defaultValues: ManagedUserValues;
  register: UseFormRegister<ManagedUserValues>;
  errors: Partial<FieldErrorsImpl<Omit<ManagedUserValues, "preferences">>>;
  isDirty: boolean;
  handleSubmit: FormEventHandler<HTMLFormElement>;
  waiting: boolean;
};

export const ManagedUserForm = ({
  defaultValues,
  register,
  errors,
  isDirty,
